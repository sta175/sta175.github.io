...
Because the data is so large, it is housed in a ZIP file. Download the ZIP file, and then extract the file that is inside of it, which should be called `train.csv`. For instructions on how to load this data in R, look <a href="https://sta175.github.io/slides/loadingData.html">here</a>.
