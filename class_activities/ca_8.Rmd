...
So far, we have covered exploratory data analysis and data wrangling, linear regression, model selection, and trees. So you have a lot of tools to work with for the competition! But when you get a new dataset, it can be daunting to plan out you're analysis. That's ok! The purpose of today's activity is to give you practice working with a new dataset and planning how you will use the tools we have learned to start analyzing it.
