...
- Run the command `setwd("/deac/sta/classes/sta175-sp-2023/your_username")`
- **NOTE: Make sure you replace `your_username` with your actual user name!!!!** 
- Now, look at the top left hand panel of RStudio, and find R 4.0.2 on the top of the Console tab. Next to it you should see something that looks like /deac/sta/classes/sta175-sp-2023/your_username
...
We will continue using the energy efficiency data from last week. If you haven't already, load the `train.csv` dataset into R (see [Activity 1](https://sta175.github.io/class_activities/ca_1.html) for full instructions).
