...
You can download the `checkpoints_pulse` data with

```{r, eval=F}
load("https://sta175.github.io/class_activities/data/checkpoints_pulse.Rdata")
```
...
It will be up to you to choose appropriate visualizations to answer the research questions from your client. Typically, there is no one right answer, and there are multiple ways you could approach the question. See the [activity from last week](https://sta175.github.io/class_activities/STA175_Activity1_Spring25.html), the [data exploration cheat sheet](https://sta175.github.io/data_visualization_summary_cheat_sheet.html), and the [ggplot help sheet](https://raw.githubusercontent.com/rstudio/cheatsheets/master/data-visualization.pdf) for possible plots you could make.
...
* You may wish to focus on certain chapters or constructs. This could be done by subsetting the data, and one way to subset is with `filter`. For example, to focus only on chapter 2:

```{r, eval=F}
library(tidyverse)

pulse_ch2 <- checkpoints_pulse |>
  filter(chapter_num == 2)
```
...
:::{.question}
#### Question 1
Create at least one figure or visualization to answer Research Question 1 from the client.
:::

:::{.question}
#### Question 2
Create at least one figure or visualization to answer Research Question 2 from the client.
:::

:::{.question}
#### Question 3
Create at least one figure or visualization to answer Research Question 3 from the client.
:::
