...
Doing this kind of data exploration requires some data wrangling tools. [These slides](https://sta175.github.io/slides/data_wrangling.html) review some useful data wrangling functions from the `dplyr` package. In this activity, you will practice using these functions to explore the energy efficiency data we started work on last time.
