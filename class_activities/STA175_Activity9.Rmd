...
Now that we have a blank canvas, let's add a slide. To make a slide on Markdown, you just need to use two hashtags (##). Look at the slide Markdown file you created in Question 3. Do you see that at the beginning of this, you have ## R Markdown? This is the title of the first slide. If you want to add a new slide, you just need two hashtags and then you type your slide title. You can create as many slides as you like!

Once you have created your title (## Research Question 1) hit enter twice to move to a line below your title. Here, you can put content just like you can in any other Markdown file. This means you can type things, insert a code chunk, etc. 
...
- `${Body Mass} = {\beta}_0 + {\beta_1} FlipperLength + \epsilon$` 
...
:::{.question}
#### Question 7 
Build an LSLR model to explore the client's research question. Write down the fitted LSLR line (meaning include numeric values for $\hat{\beta}_0$ and $\hat{\beta}_1$) on Slide 3 of your presentation.  
:::

## Slides - Adding Bullets

Now we have shown a graph and shown our LSLR line. We now need to create a slide that responds to our client's research question. This likely involves text in addition to rather than an equation or a graph.
...
:::{.question}
#### Question 8 
Based on your graph and LSLR model, respond to the client's.   
:::
